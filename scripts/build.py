...
intro=f'''<section class="opening"><div class="opening-top"><p class="kicker">Research, essays, and performances</p><span class="meta">Cambridge, MA</span></div><h1>Sophia Lin<span class="title-stop">.</span></h1><div class="biography"><div><p class="intro-line">{D['intro']}</p><p>{D['bio']}</p><p>Previously, I worked on Bayesian models of censoring and interpretable prediction from clinical records. I also play piano and write about comics, imagery, and how ideas travel.</p><div class="inline-links"><a href="@@research/">Research ↗</a><a href="@@cv.pdf">Curriculum vitae ↗</a><a href="mailto:{D['email']}">Email ↗</a></div></div><figure class="portrait"><img src="@@assets/portrait.png" width="1536" height="1024" alt="Sophia Lin speaking during a recorded conversation"><figcaption>Sophia Lin</figcaption></figure></div></section>'''
home=intro+'<section class="archive-section">'+heading('01','Research','All research','@@research/')+'<p class="section-deck">When does an evaluation deserve to be trusted?</p>'+''.join(project(x) for x in D['projects'][:2])+publications()+'</section>'
home+='<section class="archive-section">'+heading('02','Essays','All writing','@@essays/')+essayfeature()+'</section>'
x=D['performances'][0]
home+='<section class="archive-section">'+heading('03','Piano','Selected performances','@@piano/')+f'''<div class="piano-home"><span class="large-number" aria-hidden="true">20</span><div><p class="kicker">W. A. Mozart</p><h3><a href="@@piano/">Piano Concerto No. 20 in D minor ↗</a></h3><p>With the Capital City Symphony.<br><span class="meta">23 March 2025 · Washington, DC</span></p><a class="text-link" href="@@piano/">Listen <span>→</span></a></div></div></section>'''
